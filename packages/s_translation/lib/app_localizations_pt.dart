...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get deleteYouCopy => 'Excluir sua cópia';

  @override
  String get unMute => 'Remover o silenciamento';
  ...
  @override
  String get contactsHasBeenSynced => 'Contatos foram sincronizados';

  @override
  String get syncContacts => 'Sincronizar contatos';

  @override
  String get enableSearchByUserName => 'Habilitar busca por nome de usuário';

  @override
  String get acceptContactsPermissionDescription =>
      'Se você deseja ver seus contatos que usam o aplicativo, você precisa aceitar a permissão de contatos';

  @override
  String get contactPermissionDenied => 'Permissão de contatos negada';

  @override
  String get searchByUserNameOrFullUserEmail =>
      'Buscar por nome de usuário ou e-mail completo';

  @override
  String get searchByUserFullEmail => 'Buscar por e-mail completo';

  @override
  String get clearAppStorageDescription =>
      'Esta opção irá limpar o armazenamento do aplicativo. Não se preocupe, você pode baixá-lo novamente a qualquer momento se o download automático estiver ativado. A mensagem será baixada automaticamente.';

  @override
  String get acceptCallsFromUsers => 'Aceitar chamadas de usuários';
  ...
  String get messagePrivatelyWithFriendsAndFamily =>
      'Envie mensagens privadas para amigos e familiares usando seu navegador.';

  @override
  String get openAppOnYourPhoneInstructions =>
      '1. Abra o aplicativo no seu telefone. Toque em Configurações no Android, ou no iPhone. Toque em Dispositivos vinculados e depois em Vincular um dispositivo. Aponte o telefone para esta tela para escanear o código QR.';
  ...
  String get pleaseProvideYourNameToContinue =>
      'Por favor, forneça seu nome para continuar';
  ...
  @override
  String get enableSearchByEmail => 'Habilitar busca por e-mail';

  @override
  String get phoneNumberNotValid => 'número de telefone não válido';
  ...
  String get invalidVerificationCode =>
      'O código de verificação que você digitou é inválido. Por favor, verifique e tente novamente.';

  @override
  String get verificationSessionExpired =>
      'Sua sessão de verificação expirou. Por favor, solicite um novo código.';
  ...
  String verificationFailed(Object message) {
    return 'Falha na verificação: $message';
  }

  @override
  String get verificationTimedOut =>
      'Tempo de verificação esgotado. Por favor, tente novamente.';
  ...
  String get forgotPasswordNavigating =>
      'Navegando para a página de recuperação de senha';
  ...
  String get enterTheCodeAndNewPassword =>
      'Digite o código de verificação enviado para seu e-mail e crie uma nova senha';

  @override
  String get enterNewPassword => 'Digite uma nova senha';

  @override
  String get reenterNewPassword => 'Digite novamente a nova senha';
  ...
  @override
  String get codeSentAgain => 'O código foi enviado novamente para seu e-mail';

  @override
  String get clickToJoin => 'Clique para participar';

  @override
  String get storeUrls => 'URLs da loja';
  ...
  String get clickThisOptionWillClearAppStorage =>
      'Esta opção limpará o armazenamento do aplicativo. Não se preocupe, você ainda pode baixá-lo a qualquer momento se o download automático estiver ativado. A mensagem será baixada automaticamente';

  @override
  String get deleteAppCache => 'Excluir cache do aplicativo?';

  @override
  String get userRegisterStatus => 'Status de registro do usuário';

  @override
  String get isPrime => 'Usuário premium';

  @override
  String get videoCompression => 'Compressão de Vídeo';

  @override
  String get chooseQualityForYourVideo => 'Escolha a qualidade do seu vídeo';

  @override
  String get ultraLowQuality => 'Qualidade Ultra Baixa';

  @override
  String get veryLowQuality => 'Qualidade Muito Baixa';

  @override
  String get lowQuality => 'Qualidade Baixa';

  @override
  String get mediumQuality => 'Qualidade Média';

  @override
  String get highQuality => 'Qualidade Alta';

  @override
  String get smallestFileSizeFasterUpload =>
      'Menor tamanho de arquivo, upload mais rápido';

  @override
  String get verySmallFileSize => 'Tamanho de arquivo muito pequeno';

  @override
  String get smallFileSizeFasterUploadLow =>
      'Tamanho de arquivo pequeno, upload mais rápido';

  @override
  String get balancedQualityAndFileSize =>
      'Qualidade e tamanho de arquivo equilibrados';

  @override
  String get betterQualityLargerFileSize => 'Melhor qualidade, arquivo maior';

  @override
  String get skipCompression => 'Pular Compressão';
  ...
  @override
  String get compressingVideo => 'Comprimindo Vídeo';

  @override
  String get analyzingVideoAndPreparingCompression =>
      'Analisando vídeo e preparando compressão...';

  @override
  String get compressingVideoThisMayTakeAFewMoments =>
      'Comprimindo vídeo, isso pode levar alguns momentos...';

  @override
  String get processingVideoDataAndOptimizingQuality =>
      'Processando dados do vídeo e otimizando qualidade...';

  @override
  String get finalizingCompressionAndSavingFile =>
      'Finalizando compressão e salvando arquivo...';

  @override
  String get almostDoneJustAFewMoreSeconds =>
      'Quase pronto, apenas mais alguns segundos...';
  ...
  @override
  String get cancelCompression => 'Cancelar Compressão';

  @override
  String get compressionSettings => 'Configurações de Compressão';
  ...
  String compressionQualitySetTo(String quality) {
    return 'Qualidade de compressão definida para $quality. O vídeo será comprimido ao enviar.';
  }
  ...
  String videoCompressionFailed(String fileName, String error) {
    return 'Falha na compressão do vídeo $fileName: $error';
  }

  @override
  String get connectionQuality => 'Qualidade da Conexão';
  ...
  @override
  String get microphoneOff => 'Microfone Desligado';

  @override
  String get microphoneOn => 'Microfone Ligado';

  @override
  String get speakerOff => 'Alto-falante Desligado';

  @override
  String get speakerOn => 'Alto-falante Ligado';

  @override
  String get switchCamera => 'Trocar Câmera';

  @override
  String get endCall => 'Encerrar Chamada';

  @override
  String get callDuration => 'Duração da Chamada';
  ...
  @override
  String get networkPoor => 'A conexão de rede está ruim';

  @override
  String get joinCall => 'Entrar na Chamada';

  @override
  String get leaveCall => 'Sair da Chamada';

  @override
  String get tapToSwapVideo => 'Toque para trocar posições de vídeo';

  @override
  String get userJoined => 'Usuário entrou na chamada';

  @override
  String get userLeft => 'Usuário saiu da chamada';

  @override
  String get audioOnlyMode => 'Modo Apenas Áudio';

  @override
  String get videoCallMode => 'Modo Chamada de Vídeo';

  @override
  String get callQuality => 'Qualidade da Chamada';
  ...
  String get chooseCompressionQualityForYourVideo =>
      'Escolha a qualidade de compressão para seu vídeo:';
  ...
  @override
  String get fileMustBeVideo => 'O arquivo deve ser um arquivo de vídeo';

  @override
  String get fileMustBeImage => 'O arquivo deve ser um arquivo de imagem';

  @override
  String get appStorageSizeIs => 'O tamanho do armazenamento do aplicativo é';

  @override
  String get activity => 'Atividade';

  @override
  String get serverRestart => 'Reinicialização do servidor';

  @override
  String get adminDashboard => 'Painel de Administração';

  @override
  String get secureAdminAccess => 'Acesso Seguro de Administrador';

  @override
  String get userAnalytics => 'Análise de Usuários';
  ...
  @override
  String get enterAdminPassword => 'Digite sua senha de administrador';
  ...
  @override
  String get appleMacStoreUrl => 'URL da Apple Mac Store';
  ...
  @override
  String get videoTrimmer => 'Cortador de Vídeo';
  ...
  @override
  String get cropNotAvailableOnWeb => 'Recorte não disponível na web';
  ...
  @override
  String get resetTrim => 'Redefinir Corte';

  @override
  String get original => 'Original';

  @override
  String get trimmed => 'Cortado';

  @override
  String get failedToSaveTrimmedVideo => 'Falha ao salvar vídeo cortado';

  @override
  String get loadingVideo => 'Carregando vídeo...';

  @override
  String get failedToLoadVideo => 'Falha ao carregar vídeo';
  ...
  @override
  String get emptyList => 'Nenhuma mídia encontrada';

  @override
  String get unSupportedAssetType => 'Tipo de arquivo não suportado';

  @override
  String get unableToAccessAll => 'Não é possível acessar todas as fotos';

  @override
  String get viewingLimitedAssetsTip =>
      'Mostrando apenas fotos e vídeos acessíveis ao aplicativo.';

  @override
  String get changeAccessibleLimitedAssets =>
      'Alterar ativos limitados acessíveis';

  @override
  String get accessAllTip =>
      'O aplicativo só pode acessar ativos limitados no dispositivo. Vá para as configurações do sistema e permita que o aplicativo acesse todas as fotos no dispositivo.';
  ...
  @override
  String get accessiblePathName => 'Ativos acessíveis';
  ...
  @override
  String get selectMedia => 'Selecionar mídia';

  @override
  String get selectPhotos => 'Selecionar fotos';

  @override
  String get selectVideos => 'Selecionar vídeos';
  ...
  String get pleaseGrantCameraPermission =>
      'Por favor, conceda permissão da câmera';

  @override
  String get pleaseGrantStoragePermission =>
      'Por favor, conceda permissão de armazenamento';
  ...
  @override
  String get errorSharingImage => 'Erro ao compartilhar imagem';
  ...
  @override
  String get storyViewers => 'Visualizadores da História';

  @override
  String get noViewersYet => 'Ainda não há visualizadores';

  @override
  String get locationFallback => 'Localização';

  @override
  String get gpsLabel => 'GPS';

  @override
  String get tapToOpenInMaps => 'Toque para abrir no Maps';

  @override
  String get selectedLocation => 'Localização Selecionada';

  @override
  String get analyzingVideo => 'Analisando vídeo e preparando compressão...';

  @override
  String get compressingVideoWait => 'Comprimindo vídeo, por favor aguarde...';

  @override
  String get finalizingCompression => 'Finalizando compressão...';

  @override
  String get almostDone => 'Quase pronto...';

  @override
  String get failedToLoadViewers => 'Falha ao carregar visualizadores';

  @override
  String get loadingViewers => 'Carregando visualizadores...';
  ...
  @override
  String get noCustomSettings => 'Sem configurações personalizadas';
