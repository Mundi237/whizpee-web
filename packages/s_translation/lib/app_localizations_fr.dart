...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get createTextStory => 'Créer une histoire de texte';

  @override
  String get createMediaStory => 'Créer une histoire multimédia';
  ...
  @override
  String get oneTimeSeen => 'Vu une fois';
  ...
  @override
  String get contactsHasBeenSynced => 'Les contacts ont été synchronisés';

  @override
  String get syncContacts => 'Synchroniser les contacts';

  @override
  String get enableSearchByUserName =>
      'Activer la recherche par nom d\'utilisateur';

  @override
  String get acceptContactsPermissionDescription =>
      'Si vous souhaitez voir vos contacts qui utilisent l\'application, vous devez accepter l\'autorisation de contacts';

  @override
  String get contactPermissionDenied => 'Autorisation de contact refusée';

  @override
  String get searchByUserNameOrFullUserEmail =>
      'Rechercher par nom d\'utilisateur ou e-mail complet';

  @override
  String get searchByUserFullEmail => 'Rechercher par e-mail complet';

  @override
  String get clearAppStorageDescription =>
      'Cette option effacera le stockage de l\'application. Pas de souci, vous pouvez toujours le télécharger si le téléchargement automatique est activé. Le message sera téléchargé automatiquement.';

  @override
  String get acceptCallsFromUsers => 'Accepter les appels des utilisateurs';

  @override
  String get translate => 'Traduire';

  @override
  String get codePage => 'Page de code';

  @override
  String get messagePrivatelyWithFriendsAndFamily =>
      'Envoyez des messages privés à vos amis et votre famille sur votre navigateur.';

  @override
  String get openAppOnYourPhoneInstructions =>
      '1. Ouvrez l\'application sur votre téléphone. Appuyez sur Paramètres sur Android ou sur iPhone. Appuyez sur Appareils liés puis sur Lier un appareil. Pointez votre téléphone vers cet écran pour scanner le code QR.';
  ...
  String get pleaseProvideYourNameToContinue =>
      'Veuillez fournir votre nom pour continuer';
  ...
  @override
  String get enableSearchByEmail => 'Activer la recherche par e-mail';

  @override
  String get phoneNumberNotValid => 'numéro de téléphone non valide';
  ...
  String sentSixDigitCode(Object phone) {
    return 'Nous avons envoyé un code à 6 chiffres à $phone';
  }
  ...
  String get invalidVerificationCode =>
      'Le code de vérification que vous avez saisi n\'est pas valide. Veuillez vérifier et réessayer.';

  @override
  String get verificationSessionExpired =>
      'Votre session de vérification a expiré. Veuillez demander un nouveau code.';
  ...
  String get verificationTimedOut =>
      'Délai de vérification dépassé. Veuillez réessayer.';
  ...
  String get enterTheCodeAndNewPassword =>
      'Entrez le code de vérification envoyé à votre adresse e-mail et créez un nouveau mot de passe';

  @override
  String get enterNewPassword => 'Entrez un nouveau mot de passe';

  @override
  String get reenterNewPassword => 'Entrez à nouveau le nouveau mot de passe';
  ...
  @override
  String get codeSentAgain => 'Le code a été renvoyé à votre adresse e-mail';

  @override
  String get clickToJoin => 'Cliquez pour rejoindre';

  @override
  String get storeUrls => 'URLs des magasins';
  ...
  String get clickThisOptionWillClearAppStorage =>
      'Cette option effacera le stockage de l\'application. Ne vous inquiétez pas, vous pouvez toujours le télécharger à nouveau si le téléchargement automatique est activé. Le message sera téléchargé automatiquement';

  @override
  String get deleteAppCache => 'Supprimer le cache de l\'application ?';

  @override
  String get userRegisterStatus => 'Statut d\'enregistrement de l\'utilisateur';

  @override
  String get isPrime => 'Est premier';

  @override
  String get videoCompression => 'Compression Vidéo';

  @override
  String get chooseQualityForYourVideo =>
      'Choisissez la qualité de votre vidéo';

  @override
  String get ultraLowQuality => 'Qualité Ultra Basse';

  @override
  String get veryLowQuality => 'Qualité Très Basse';

  @override
  String get lowQuality => 'Qualité Basse';

  @override
  String get mediumQuality => 'Qualité Moyenne';

  @override
  String get highQuality => 'Qualité Élevée';

  @override
  String get smallestFileSizeFasterUpload =>
      'Taille de fichier la plus petite, téléchargement plus rapide';

  @override
  String get verySmallFileSize => 'Taille de fichier très petite';

  @override
  String get smallFileSizeFasterUploadLow =>
      'Petite taille de fichier, téléchargement plus rapide';

  @override
  String get balancedQualityAndFileSize =>
      'Équilibre entre qualité et taille de fichier';
  ...
  @override
  String get skipCompression => 'Ignorer la Compression';

  @override
  String get sendOriginalVideoWithoutCompression =>
      'Envoyer la vidéo originale sans compression';

  @override
  String get apply => 'Appliquer';

  @override
  String get compressingVideo => 'Compression Vidéo';

  @override
  String get analyzingVideoAndPreparingCompression =>
      'Analyse de la vidéo et préparation de la compression...';

  @override
  String get compressingVideoThisMayTakeAFewMoments =>
      'Compression de la vidéo, cela peut prendre quelques instants...';

  @override
  String get processingVideoDataAndOptimizingQuality =>
      'Traitement des données vidéo et optimisation de la qualité...';

  @override
  String get finalizingCompressionAndSavingFile =>
      'Finalisation de la compression et sauvegarde du fichier...';
  ...
  @override
  String get finishing => 'Finalisation...';
  ...
  @override
  String get compressionSettings => 'Paramètres de Compression';
  ...
  String compressionQualitySetTo(String quality) {
    return 'Qualité de compression définie sur $quality. La vidéo sera compressée lors de l\'envoi.';
  }

  @override
  String errorProcessingMedia(String error) {
    return 'Erreur de traitement des médias : $error';
  }

  @override
  String videoCompressionFailed(String fileName, String error) {
    return 'Échec de la compression vidéo pour $fileName : $error';
  }

  @override
  String get connectionQuality => 'Qualité de Connexion';
  ...
  @override
  String get cameraOff => 'Caméra Éteinte';

  @override
  String get cameraOn => 'Caméra Allumée';

  @override
  String get microphoneOff => 'Microphone Éteint';

  @override
  String get microphoneOn => 'Microphone Allumé';

  @override
  String get speakerOff => 'Haut-parleur Éteint';

  @override
  String get speakerOn => 'Haut-parleur Allumé';
  ...
  @override
  String get callDuration => 'Durée de l\'Appel';
  ...
  @override
  String get networkPoor => 'La connexion réseau est mauvaise';

  @override
  String get joinCall => 'Rejoindre l\'Appel';

  @override
  String get leaveCall => 'Quitter l\'Appel';

  @override
  String get tapToSwapVideo => 'Appuyez pour échanger les positions vidéo';

  @override
  String get userJoined => 'L\'utilisateur a rejoint l\'appel';

  @override
  String get userLeft => 'L\'utilisateur a quitté l\'appel';

  @override
  String get audioOnlyMode => 'Mode Audio Seulement';

  @override
  String get videoCallMode => 'Mode Appel Vidéo';

  @override
  String get callQuality => 'Qualité de l\'Appel';
  ...
  String get chooseCompressionQualityForYourVideo =>
      'Choisissez la qualité de compression pour votre vidéo :';

  @override
  String get originalFileSize => 'Original';

  @override
  String get estimatedFileSize => 'Estimé';

  @override
  String get fileMustBeVideo => 'Le fichier doit être un fichier vidéo';

  @override
  String get fileMustBeImage => 'Le fichier doit être un fichier image';

  @override
  String get appStorageSizeIs => 'La taille de stockage de l\'application est';

  @override
  String get activity => 'Activité';

  @override
  String get serverRestart => 'Redémarrage du serveur';

  @override
  String get adminDashboard => 'Tableau de Bord Administrateur';

  @override
  String get secureAdminAccess => 'Accès Administrateur Sécurisé';

  @override
  String get userAnalytics => 'Analytique des Utilisateurs';
  ...
  @override
  String get enterAdminPassword => 'Entrez votre mot de passe administrateur';
  ...
  @override
  String get videoTrimmer => 'Découpeur Vidéo';
  ...
  @override
  String get cropNotAvailableOnWeb => 'Recadrage non disponible sur le web';
  ...
  @override
  String get resetTrim => 'Réinitialiser le Découpage';

  @override
  String get original => 'Original';

  @override
  String get trimmed => 'Découpé';

  @override
  String get failedToSaveTrimmedVideo =>
      'Échec de la sauvegarde de la vidéo découpée';
  ...
  @override
  String get emptyList => 'Aucun média trouvé';

  @override
  String get unSupportedAssetType => 'Type de fichier non pris en charge';

  @override
  String get unableToAccessAll => 'Impossible d\'accéder à toutes les photos';

  @override
  String get viewingLimitedAssetsTip =>
      'Affichage uniquement des photos et vidéos accessibles à l\'application.';

  @override
  String get changeAccessibleLimitedAssets =>
      'Modifier les ressources limitées accessibles';

  @override
  String get accessAllTip =>
      'L\'application ne peut accéder qu\'aux ressources limitées de l\'appareil. Allez dans les paramètres système et autorisez l\'application à accéder à toutes les photos de l\'appareil.';

  @override
  String get goToSystemSettings => 'Aller aux paramètres système';

  @override
  String get accessLimitedAssets => 'Continuer avec un accès limité';

  @override
  String get accessiblePathName => 'Ressources accessibles';
  ...
  @override
  String get sActionSelectHint => 'Sélectionner';
  ...
  @override
  String get selectMedia => 'Sélectionner des médias';

  @override
  String get selectPhotos => 'Sélectionner des photos';

  @override
  String get selectVideos => 'Sélectionner des vidéos';
  ...
  @override
  String get imageInfo => 'Informations sur l\'image';
  ...
  @override
  String get errorSharingImage => 'Erreur lors du partage de l\'image';
  ...
  @override
  String get storyViewers => 'Spectateurs de l\'Histoire';

  @override
  String get noViewersYet => 'Pas encore de spectateurs';

  @override
  String get locationFallback => 'Emplacement';

  @override
  String get gpsLabel => 'GPS';

  @override
  String get tapToOpenInMaps => 'Appuyez pour ouvrir dans les Cartes';
  ...
  String get compressingVideoWait =>
      'Compression de la vidéo, veuillez patienter...';

  @override
  String get finalizingCompression => 'Finalisation de la compression...';

  @override
  String get almostDone => 'Presque terminé...';

  @override
  String get failedToLoadViewers => 'Échec du chargement des spectateurs';

  @override
  String get loadingViewers => 'Chargement des spectateurs...';
  ...
  @override
  String get noCustomSettings => 'Aucun paramètre personnalisé';
