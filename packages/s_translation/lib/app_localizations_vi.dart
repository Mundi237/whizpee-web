...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get acceptContactsPermissionDescription =>
      'Nếu bạn muốn xem danh bạ sử dụng ứng dụng, bạn cần chấp nhận quyền truy cập danh bạ';
  ...
  String get searchByUserNameOrFullUserEmail =>
      'Tìm kiếm theo tên người dùng hoặc email đầy đủ';
  ...
  String get clearAppStorageDescription =>
      'Tùy chọn này sẽ xóa dữ liệu ứng dụng. Đừng lo lắng, bạn vẫn có thể tải xuống bất kỳ lúc nào nếu tải xuống tự động được bật. Tin nhắn sẽ được tải xuống tự động.';
  ...
  String get messagePrivatelyWithFriendsAndFamily =>
      'Gửi tin nhắn riêng tư với bạn bè và gia đình qua trình duyệt của bạn.';

  @override
  String get openAppOnYourPhoneInstructions =>
      '1. Mở ứng dụng trên điện thoại của bạn. Nhấn vào Cài đặt trên Android hoặc trên iPhone. Nhấn vào Thiết bị được liên kết và sau đó Liên kết thiết bị. Hướng điện thoại của bạn vào màn hình này để quét mã QR.';
  ...
  String get pleaseProvideYourNameToContinue =>
      'Vui lòng cung cấp tên của bạn để tiếp tục';
  ...
  String get invalidVerificationCode =>
      'Mã xác minh bạn đã nhập không hợp lệ. Vui lòng kiểm tra và thử lại.';

  @override
  String get verificationSessionExpired =>
      'Phiên xác minh của bạn đã hết hạn. Vui lòng yêu cầu mã mới.';
  ...
  String get verificationTimedOut =>
      'Đã hết thời gian xác minh. Vui lòng thử lại.';
  ...
  @override
  String get storeUrls => 'URL cửa hàng';

  @override
  String get clearAllCache => 'Xóa tất cả bộ nhớ cache';
  ...
  @override
  String get deleteAppCache => 'Xóa bộ nhớ cache của ứng dụng?';

  @override
  String get userRegisterStatus => 'Trạng thái đăng ký người dùng';

  @override
  String get isPrime => 'Có phải là số nguyên tố không';

  @override
  String get videoCompression => 'Nén Video';

  @override
  String get chooseQualityForYourVideo => 'Chọn chất lượng cho video của bạn';

  @override
  String get ultraLowQuality => 'Chất Lượng Cực Thấp';

  @override
  String get veryLowQuality => 'Chất Lượng Rất Thấp';

  @override
  String get lowQuality => 'Chất Lượng Thấp';

  @override
  String get mediumQuality => 'Chất Lượng Trung Bình';

  @override
  String get highQuality => 'Chất Lượng Cao';
  ...
  @override
  String get verySmallFileSize => 'Kích thước file rất nhỏ';
  ...
  @override
  String get skipCompression => 'Bỏ Qua Nén';

  @override
  String get sendOriginalVideoWithoutCompression => 'Gửi video gốc không nén';

  @override
  String get apply => 'Áp Dụng';

  @override
  String get compressingVideo => 'Đang Nén Video';
  ...
  @override
  String get finishing => 'Đang hoàn thành...';

  @override
  String get estimating => 'Đang ước tính...';
  ...
  @override
  String get cancelCompression => 'Hủy Nén';

  @override
  String get compressionSettings => 'Cài Đặt Nén';
  ...
  String compressionQualitySetTo(String quality) {
    return 'Chất lượng nén đã được đặt thành $quality. Video sẽ được nén khi gửi.';
  }

  @override
  String errorProcessingMedia(String error) {
    return 'Lỗi xử lý media: $error';
  }

  @override
  String videoCompressionFailed(String fileName, String error) {
    return 'Nén video $fileName thất bại: $error';
  }

  @override
  String get connectionQuality => 'Chất Lượng Kết Nối';
  ...
  @override
  String get cameraOff => 'Tắt Camera';

  @override
  String get cameraOn => 'Bật Camera';

  @override
  String get microphoneOff => 'Tắt Microphone';

  @override
  String get microphoneOn => 'Bật Microphone';

  @override
  String get speakerOff => 'Tắt Loa';

  @override
  String get speakerOn => 'Bật Loa';

  @override
  String get switchCamera => 'Chuyển Camera';

  @override
  String get endCall => 'Kết Thúc Cuộc Gọi';

  @override
  String get callDuration => 'Thời Gian Cuộc Gọi';
  ...
  @override
  String get networkPoor => 'Kết nối mạng kém';

  @override
  String get joinCall => 'Tham Gia Cuộc Gọi';

  @override
  String get leaveCall => 'Rời Cuộc Gọi';

  @override
  String get tapToSwapVideo => 'Nhấn để hoán đổi vị trí video';

  @override
  String get userJoined => 'Người dùng đã tham gia cuộc gọi';

  @override
  String get userLeft => 'Người dùng đã rời cuộc gọi';

  @override
  String get audioOnlyMode => 'Chế Độ Chỉ Âm Thanh';

  @override
  String get videoCallMode => 'Chế Độ Gọi Video';

  @override
  String get callQuality => 'Chất Lượng Cuộc Gọi';
  ...
  @override
  String get originalFileSize => 'Gốc';

  @override
  String get estimatedFileSize => 'Ước tính';

  @override
  String get fileMustBeVideo => 'File phải là file video';

  @override
  String get fileMustBeImage => 'File phải là file hình ảnh';

  @override
  String get appStorageSizeIs => 'Kích thước lưu trữ ứng dụng là';

  @override
  String get activity => 'Hoạt động';

  @override
  String get serverRestart => 'Khởi động lại máy chủ';

  @override
  String get adminDashboard => 'Bảng điều khiển Quản trị viên';

  @override
  String get secureAdminAccess => 'Truy cập Quản trị viên An toàn';

  @override
  String get userAnalytics => 'Phân tích Người dùng';

  @override
  String get systemConfiguration => 'Cấu hình Hệ thống';
  ...
  @override
  String get enterAdminPassword => 'Nhập mật khẩu quản trị viên của bạn';

  @override
  String get needHelp => 'Cần giúp đỡ?';
  ...
  @override
  String get webChat => 'Trò chuyện Web';
  ...
  @override
  String get videoTrimmer => 'Trình cắt video';
  ...
  @override
  String get cropImage => 'Cắt hình ảnh';

  @override
  String get cropNotAvailableOnWeb => 'Cắt không khả dụng trên web';

  @override
  String get editImage => 'Chỉnh sửa hình ảnh';

  @override
  String get editVideo => 'Chỉnh sửa video';

  @override
  String get resetTrim => 'Đặt lại cắt';

  @override
  String get original => 'Gốc';

  @override
  String get trimmed => 'Đã cắt';

  @override
  String get failedToSaveTrimmedVideo => 'Không thể lưu video đã cắt';
  ...
  @override
  String get emptyList => 'Không tìm thấy phương tiện';

  @override
  String get unSupportedAssetType => 'Loại tệp không được hỗ trợ';

  @override
  String get unableToAccessAll => 'Không thể truy cập tất cả ảnh';
  ...
  @override
  String get selectMedia => 'Chọn phương tiện';
  ...
  @override
  String get noMediaFound => 'Không tìm thấy phương tiện';

  @override
  String get permissionDenied => 'Quyền bị từ chối';

  @override
  String get pleaseGrantCameraPermission => 'Vui lòng cấp quyền camera';

  @override
  String get pleaseGrantStoragePermission => 'Vui lòng cấp quyền lưu trữ';

  @override
  String get errorLoadingImage => 'Lỗi tải hình ảnh';
  ...
  @override
  String get imageInfo => 'Thông tin hình ảnh';

  @override
  String get errorDownloadingImage => 'Lỗi tải xuống hình ảnh';

  @override
  String get errorSharingImage => 'Lỗi chia sẻ hình ảnh';
  ...
  @override
  String get storyViewers => 'Người xem câu chuyện';

  @override
  String get noViewersYet => 'Chưa có người xem';

  @override
  String get locationFallback => 'Vị trí';

  @override
  String get gpsLabel => 'GPS';

  @override
  String get tapToOpenInMaps => 'Nhấn để mở trong Bản đồ';

  @override
  String get selectedLocation => 'Vị trí đã chọn';

  @override
  String get analyzingVideo => 'Đang phân tích video và chuẩn bị nén...';

  @override
  String get compressingVideoWait => 'Đang nén video, vui lòng chờ...';

  @override
  String get finalizingCompression => 'Hoàn tất nén...';

  @override
  String get almostDone => 'Gần xong...';

  @override
  String get failedToLoadViewers => 'Không thể tải người xem';

  @override
  String get loadingViewers => 'Đang tải người xem...';

  @override
  String get changeLanguage => 'Thay đổi ngôn ngữ';

  @override
  String get toggleTheme => 'Chuyển đổi giao diện';

  @override
  String get noCustomSettings => 'Không có cài đặt tùy chỉnh';
