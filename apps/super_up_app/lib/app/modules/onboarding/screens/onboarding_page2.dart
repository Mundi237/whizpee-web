...
class _OnboardingPage2State extends State<OnboardingPage2>
            ...
            children: [
              ...
              Positioned(
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      width: 240 - (25 * _floatController.value),
                      height: 240 - (25 * _floatController.value),
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        gradient: RadialGradient(
                          colors: [
                    ...
                    return Row(
                      children: [
                        ...
                        Expanded(
                          flex: 1,
                          child: Center(
                            child: _buildIconSection(size, accentColor),
                          ),
                        ),
                            ...
                            child: ConstrainedBox(
                              ...
                              child: IntrinsicHeight(
                                child: Column(
                                  ...
                                  children: [
                                    const Spacer(flex: 1),
                                    _buildIconSection(size, accentColor),
  ...
  Widget _buildIconSection(Size size, Color accentColor) {
  ...
  Widget _buildTextSection(Color accentColor) {
    return Padding(
          ...
          child: BackdropFilter(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Recevez des crédits pour chaque contact et boostez votre profil.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 16,
                ...
                Text(
                  "Faites des transactions sécurisées et gagnez des récompenses. Avec Whizpee, chaque interaction est une opportunité.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 15,
            ...
            children: [
              ...
              GestureDetector(
                ...
                onTapUp: (_) {
                  ...
                  context.toPage(const OnboardingPage3());
                },
                onTapCancel: () {
                  setState(() => _isButtonHovered = false);
                },
